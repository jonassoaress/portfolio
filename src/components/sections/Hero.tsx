      ...
      <div className="container mx-auto px-6 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-500 mb-12 max-w-2xl mx-auto">
            ...
            Next.js e Node.js. Apaixonado por código limpo e soluções criativas
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link
              href="/projetos"
              className="px-8 py-4 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all transform hover:scale-105 font-medium shadow-lg hover:shadow-xl"
            >
              Ver Projetos
            </Link>
            <Link
